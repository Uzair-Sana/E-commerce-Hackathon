...
const TrendingProducts = () => {
    const Products = [
        { id:1, image: "/chair5.png"},
        { id: 2, image: "/chair6.png"},
        { id:3, image: "/chair7.png"},
        { id:4, image: "/latest5.png"}
    ];
    const exclusiveProducts=[
        {id: 1, image: "/chair8.png"},
        {id: 2, image: "/chair9.png"},
        {id: 3, image: "/chair10.png"}
    ]
  return (
    <div className='py-10 px-4'>
        <div className='max-w-7xl mx-auto'>
            <h2 className='text-3xl font-bold text-center mb-8 text-[#151875] '>Trending Products</h2>
