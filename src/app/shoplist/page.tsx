            ...
            >
              ...
              <div className="lg:w-2/3 lg:ml-6 mt-4 lg:mt-0">
                ...
                <div className="mt-4 flex space-x-4">
                  <button title="wishlist" className="flex items-center justify-center w-10 h-10 bg-gray-200 rounded-full hover:bg-gray-300">
                    <AiOutlineHeart size={24} />
                  </button>
                  <Link href="/cart">
                    <button title="add to cart " className="flex items-center justify-center w-10 h-10 bg-gray-200 rounded-full hover:bg-gray-300">
                      <AiOutlineShoppingCart size={24} />
                    </button>
                  </Link>
                  <button title="inspect" className="flex items-center justify-center w-10 h-10 bg-gray-200 rounded-full hover:bg-gray-300">
